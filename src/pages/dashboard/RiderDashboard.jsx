...
const RiderDashboard = () => {
    ...
    const { data: deliveryStatus = [], isLoading, isError, error } = useQuery({
        queryKey: ["riderParcelStatusCount"],
        queryFn: async () => {
            // Update the endpoint below to the correct one for rider status count
    ...
    return (
        <div className="p-6">
            <h1 className="text-3xl font-bold mb-6">Your Parcel Delivery Summary</h1>
